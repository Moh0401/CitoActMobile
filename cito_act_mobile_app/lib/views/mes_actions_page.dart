...
class MesActionPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('MES ACTIONS', style: TextStyle(fontSize: 24, color: Color(0xFF6887B0), fontWeight: FontWeight.bold)),
        centerTitle: true,
