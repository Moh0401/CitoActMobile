...
class ChatScreenAction extends StatefulWidget {
  final String chatGroupId;

  const ChatScreenAction({Key? key, required this.chatGroupId}) : super(key: key);

  @override
  _ChatScreenActionState createState() => _ChatScreenActionState();
}

class _ChatScreenActionState extends State<ChatScreenAction> {
